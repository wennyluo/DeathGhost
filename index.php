		...
		<h2>
			...
			<ul>
				<li>
					<dl>
						<dt>
							<i class="icon-columns"></i>用户列表<i class="icon-angle-right"></i>
						</dt>
						<dd>
		...
		<header class="top-hd">
			...
			<div class="hd-rt">
				<ul>
					...
					<li>
						<a><i class="icon-user"></i>管理员:<em><?php echo $_SESSION['username']; ?></em></a>
					</li>
					<li>
						<a><i class="icon-bell-alt"></i>系统消息</a>
					</li>
					<li>
                    	<a href="exit.php"><i class="icon-signout"></i>安全退出</a>
                        <!--
